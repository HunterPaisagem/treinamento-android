...
import br.com.cwi.nespresso_app.presentation.products.coffee.viewHolder.CoffeeViewHolder
import br.com.cwi.nespresso_app.presentation.products.viewHolder.CategoryViewHolder

class CapsulesAdapter(val context: Context, val list: List<Type>): Adapter<ViewHolder>() {
